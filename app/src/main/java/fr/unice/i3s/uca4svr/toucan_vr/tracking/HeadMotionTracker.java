 ...
 * as yyyy_MM_dd_HH_mm_ss and an IDnumber generated by parameterizer.
...
public class HeadMotionTracker {
  ...
  private String createLogFileName(String logFilePrefix) {
    ...
    Date date = new Date();
    return String.format("%s_headMotion_%s_ID#%s.csv", logFilePrefix, dateFormat.format(date), PlayerActivity.getUserID());
  }
